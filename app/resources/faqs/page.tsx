...
const faqCategories = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Yes. The core Sentill platform — including provider directories, yield comparisons, and market intelligence — is 100% free. Our Pro tier unlocks AI projections, yield alerts, and advanced portfolio modelling at KES 499/month — less than KES 16/day."
      },
      {
