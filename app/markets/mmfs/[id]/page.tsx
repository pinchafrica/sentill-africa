...
const FUNDS: Record<string, any> = {
  etca: {
    id: "etca", code: "ETCA", name: "Etica Wealth MMF", manager: "Etica Capital Ltd",
    yield7d: 17.55, yield30d: 17.21, yield90d: 16.89, yield1y: 16.2,
    aum: 4.2, minInvest: 100, liquidity: "T+1", risk: "Low", riskScore: 18,
    taxRate: 15, netYield: 14.92, esg: 82, cmaLicensed: true, inceptionDate: "2019",
    nav: 1.0847, currency: "KES", mgmtFee: 1.5, perfFee: 0,
    ...
    yieldHistory: [
      ...
      { month: "Dec'25", yield: 17.2 }, { month: "Jan'26", yield: 17.3 }, { month: "Feb'26", yield: 17.5 },
    ],
    navHistory: [
    ...
    peers: [
      { id: "snlm", name: "Sanlam MMF", yield: 14.78, color: "#6366f1" },
      { id: "brtm", name: "Britam MMF", yield: 14.2, color: "#f59e0b" },
      { id: "eqty", name: "Equity MMF", yield: 13.8, color: "#8b5cf6" },
    ],
    news: [
      { title: "Etica Wealth MMF Extends Yield Lead with 17.55% 7-Day Return", time: "1d ago", source: "Business Daily" },
  ...
  brtm: {
    id: "brtm", code: "BRTM", name: "Britam MMF", manager: "Britam Asset Managers",
    yield7d: 14.2, yield30d: 13.95, yield90d: 13.7, yield1y: 13.1,
    aum: 12.4, minInvest: 500, liquidity: "T+1", risk: "Low", riskScore: 15,
    taxRate: 15, netYield: 12.07, esg: 71, cmaLicensed: true, inceptionDate: "2010",
...
const EXTRA_FUNDS: Record<string, any> = {
  "sanlam": { name: "Sanlam MMF", manager: "Sanlam Investments", yield7d: 14.20 },
  "cic": { name: "CIC MMF", manager: "CIC Asset Management", yield7d: 15.90 },
  "cicm": { name: "CIC MMF", manager: "CIC Asset Management", yield7d: 15.90 },
  "omam": { name: "Old Mutual MMF", manager: "Old Mutual Investment Group", yield7d: 14.00 },
  "cytonn": { name: "Cytonn MMF", manager: "Cytonn Investments", yield7d: 15.2 },
  "nabo": { name: "Nabo Africa MMF", manager: "Nabo Capital", yield7d: 14.85 },
  "icea": { name: "ICEA Lion MMF", manager: "ICEA Lion Asset Management", yield7d: 13.6 },
  "zimele": { name: "Zimele MMF", manager: "Zimele Asset Management", yield7d: 12.8 },
  "genghis": { name: "Genghis Capital MMF", manager: "Genghis Capital", yield7d: 14.5 },
  "lofty": { name: "Lofty Corban MMF", manager: "Lofty Corban Investments", yield7d: 16.1 },
  ...
  "oldmutual": { name: "Old Mutual MMF", manager: "Old Mutual Investment Group", yield7d: 14.00 },
  "equity-mmf": { name: "Equity MMF", manager: "Equity Investment Bank", yield7d: 13.8 },
  ...
  "absa-mmf": { name: "Absa MMF", manager: "Absa Asset Management", yield7d: 12.5 },
