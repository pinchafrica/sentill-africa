...
const STOCKS: Record<string, any> = {
  SCOM: {
    ...
    price: 19.35, change: +0.15, changePercent: +0.78, prevClose: 19.20,
    open: 19.20, high: 19.55, low: 19.10, volume: "48.2M", avgVolume: "42.1M",
    marketCap: "775B", sharesOut: "40.1B", freefloat: "35%",
    high52: 22.50, low52: 14.50, beta: 0.82,
    pe: 12.1, eps: 1.60, ps: 2.1, pb: 3.2, ev: "820B",
    divYield: 4.5, divPerShare: 0.87, payoutRatio: "54%", exDivDate: "Aug 2026",
    ...
    priceHistory: [
      ...
      { date: "Dec'25", price: 19.80 }, { date: "Jan'26", price: 20.10 }, { date: "Apr'26", price: 19.35 },
    ],
    volumeHistory: [
    ...
    analystRating: { buy: 8, hold: 7, sell: 1, target: 23.00 },
  },
  EQT: {
    ...
    price: 48.05, change: -0.45, changePercent: -0.93, prevClose: 48.50,
    open: 48.40, high: 48.70, low: 47.80, volume: "12.4M", avgVolume: "10.8M",
    marketCap: "182B", sharesOut: "3.8B", freefloat: "68%",
    high52: 52.00, low52: 34.00, beta: 1.12,
    pe: 6.2, eps: 7.75, ps: 1.3, pb: 1.8, ev: "195B",
    divYield: 5.2, divPerShare: 2.50, payoutRatio: "32%", exDivDate: "Sep 2026",
    ...
    priceHistory: [
      ...
      { date: "Dec'25", price: 46.50 }, { date: "Jan'26", price: 47.20 }, { date: "Apr'26", price: 48.05 },
    ],
    volumeHistory: [
    ...
    analystRating: { buy: 9, hold: 5, sell: 1, target: 58.00 },
  },
  KCBG: {
    symbol: "KCBG", name: "KCB Group PLC", sector: "Banking", industry: "Commercial Banking",
    tvSymbol: "NSEKE:KCBG", exchange: "NSE", currency: "KES",
    price: 37.20, change: +0.70, changePercent: +1.92, prevClose: 36.50,
    open: 36.80, high: 37.50, low: 36.60, volume: "8.2M", avgVolume: "7.4M",
    marketCap: "119B", sharesOut: "3.2B", freefloat: "73%",
    high52: 40.00, low52: 26.00, beta: 1.05,
    pe: 4.9, eps: 7.59, ps: 1.0, pb: 1.6, ev: "130B",
    divYield: 8.3, divPerShare: 3.09, payoutRatio: "41%", exDivDate: "Sep 2026",
    ...
    priceHistory: [
      ...
      { date: "Dec'25", price: 35.80 }, { date: "Jan'26", price: 36.40 }, { date: "Apr'26", price: 37.20 },
    ],
    volumeHistory: [
    ...
    analystRating: { buy: 9, hold: 5, sell: 1, target: 45.00 },
  },
};
...
const EXTRA_STOCKS: Record<string, any> = {
  "COOP": { name: "Co-op Bank",            price: 12.55,  change: -0.20, changePercent: -1.57, industry: "Banking" },
  "EABL": { name: "East African Breweries", price: 125.50, change: -2.50, changePercent: -1.95, industry: "Manufacturing" },
  "BAT":  { name: "BAT Kenya",              price: 430.00, change: +5.00, changePercent: +1.18, industry: "Manufacturing" },
  "ABSA": { name: "Absa Bank Kenya",        price: 14.30,  change: -0.20, changePercent: -1.38, industry: "Banking" },
  "SCBK": { name: "Standard Chartered",     price: 176.00, change: -1.00, changePercent: -0.56, industry: "Banking" },
  "IMH":  { name: "I&M Group",              price: 22.50,  change: +0.30, changePercent: +1.35, industry: "Banking" },
  "BAMB": { name: "Bamburi Cement",         price: 64.50,  change: +1.25, changePercent: +1.97, industry: "Construction" },
  "KPLC": { name: "Kenya Power",            price:  2.35,  change: -0.05, changePercent: -2.08, industry: "Energy" },
  "KEGN": { name: "KenGen",                 price:  4.98,  change: +0.08, changePercent: +1.63, industry: "Energy" },
  "CTUM": { name: "Centum Investment",      price:  8.50,  change: -0.10, changePercent: -1.16, industry: "Investment" },
  "JUB":  { name: "Jubilee Holdings",       price: 185.00, change: +1.50, changePercent: +0.82, industry: "Insurance" },
  "DTK":  { name: "Diamond Trust Bank",     price: 48.00,  change: +0.80, changePercent: +1.69, industry: "Banking" }
};
