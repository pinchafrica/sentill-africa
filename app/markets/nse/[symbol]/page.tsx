...
const STOCKS: Record<string, any> = {
  SCOM: {
    ...
    price: 19.35, change: +0.35, changePercent: +1.84, prevClose: 19.00,
    open: 19.10, high: 19.55, low: 18.90, volume: "48.2M", avgVolume: "42.1M",
    marketCap: "775.2B", sharesOut: "40.1B", freefloat: "35%",
    high52: 24.50, low52: 16.00, beta: 0.82,
    pe: 14.2, eps: 1.36, ps: 2.1, pb: 3.4, ev: "820B",
    divYield: 7.8, divPerShare: 1.51, payoutRatio: "111%", exDivDate: "Aug 2025",
    ...
    priceHistory: [
      ...
      { date: "Dec'25", price: 20.40 }, { date: "Jan'26", price: 19.80 }, { date: "Feb'26", price: 19.35 },
    ],
    volumeHistory: [
    ...
    analystRating: { buy: 12, hold: 4, sell: 1, target: 22.50 },
  },
  EQT: {
    ...
    price: 47.50, change: +0.85, changePercent: +1.82, prevClose: 46.65,
    open: 46.80, high: 48.10, low: 46.50, volume: "12.4M", avgVolume: "10.8M",
    marketCap: "178.2B", sharesOut: "3.8B", freefloat: "68%",
    high52: 58.00, low52: 38.50, beta: 1.12,
    pe: 8.4, eps: 5.65, ps: 1.2, pb: 1.8, ev: "195B",
    divYield: 9.2, divPerShare: 4.37, payoutRatio: "77%", exDivDate: "Sep 2025",
    ...
    priceHistory: [
      ...
      { date: "Dec'25", price: 50.50 }, { date: "Jan'26", price: 48.90 }, { date: "Feb'26", price: 47.50 },
    ],
    volumeHistory: [
    ...
    analystRating: { buy: 10, hold: 5, sell: 2, target: 56.00 },
  },
  KCBG: {
    symbol: "KCBG", name: "KCB Group PLC", sector: "Banking", industry: "Commercial Banking",
    tvSymbol: "NSEKE:KCBG", exchange: "NSE", currency: "KES",
    price: 34.20, change: -0.30, changePercent: -0.87, prevClose: 34.50,
    open: 34.45, high: 34.60, low: 33.90, volume: "8.2M", avgVolume: "7.4M",
    marketCap: "110.1B", sharesOut: "3.2B", freefloat: "73%",
    high52: 44.00, low52: 28.00, beta: 1.05,
    pe: 7.1, eps: 4.82, ps: 0.9, pb: 1.4, ev: "125B",
    divYield: 8.8, divPerShare: 3.01, payoutRatio: "62%", exDivDate: "Sep 2025",
    ...
    priceHistory: [
      ...
      { date: "Dec'25", price: 36.80 }, { date: "Jan'26", price: 35.40 }, { date: "Feb'26", price: 34.20 },
    ],
    volumeHistory: [
    ...
    analystRating: { buy: 8, hold: 6, sell: 2, target: 42.00 },
  },
};
...
const EXTRA_STOCKS: Record<string, any> = {
  "COOP": { name: "Co-op Bank", price: 11.5, change: +0.20, changePercent: +1.8, industry: "Banking" },
  "EABL": { name: "East African Breweries", price: 120.0, change: +1.50, changePercent: +1.3, industry: "Manufacturing" },
  "BAT": { name: "BAT Kenya", price: 420.0, change: -5.00, changePercent: -1.2, industry: "Manufacturing" },
  "ABSA": { name: "Absa Bank Kenya", price: 12.8, change: +0.15, changePercent: +1.2, industry: "Banking" },
  "SCBK": { name: "Standard Chartered", price: 165.0, change: +2.00, changePercent: +1.2, industry: "Banking" },
      ...
      <div className="px-6 md:px-10 py-8 space-y-8">
        ...
        <div className="bg-gradient-to-br from-slate-900 to-indigo-950 rounded-[2.5rem] p-8 text-white relative overflow-hidden group">
          <div className="flex items-center gap-3 mb-6 relative z-10">
            ...
            <div>
              <h2 className="text-sm font-black uppercase tracking-widest">Sentil AI · {stock.symbol} Catalyst</h2>
            ...
            <div className="relative z-10">
               {isAiLoading ? (
                 <div className="flex items-center gap-3 py-4">
                   ...
                   <span className="text-slate-400 text-sm font-medium italic">Sentil AI is analyzing {stock.symbol}...</span>
                 </div>
               ) : (
