...
const AI_RECOMMENDATIONS = [
  { symbol: "KCB", name: "KCB Group", signal: "BUY", target: "KES 45.00", confidence: "91%", reason: "8.3% dividend yield at KES 37.20. Trading below book value." },
  { symbol: "NCBA", name: "NCBA Group", signal: "BUY", target: "KES 60.00", confidence: "89%", reason: "9.2% div yield at KES 49.85. KES 4.60/share — books close Apr 30." },
  { symbol: "COOP", name: "Co-operative Bank", signal: "BUY", target: "KES 16.00", confidence: "84%", reason: "SACCO banking network advantage, 8.1% div yield at KES 12.55." },
  { symbol: "SCOM", name: "Safaricom PLC", signal: "HOLD", target: "KES 23.00", confidence: "81%", reason: "Ziidi + M-PESA long-term moat. 4.5% dividend payer at KES 19.35." },
  { symbol: "KEGN", name: "KenGen PLC", signal: "BUY", target: "KES 6.20", confidence: "78%", reason: "Renewable energy play, oversold RSI, government backing." },
  { symbol: "EABL", name: "East African Breweries", signal: "WATCH", target: "KES 115.00", confidence: "72%", reason: "Premium brand but expensive P/E 17x at KES 125.50. Tax pressures." },
