...
const PLANS = [
  ...
  },
  {
    ...
    features: ["Unlimited AI Oracle + 4 Advisor Personas", "Full Portfolio Tracker", "KRA Tax Optimizer", "Real-Time WhatsApp Alerts", "NSE Charts RSI+MACD", "Dividend Countdown Alerts", "Estate Vault", "Priority Support"],
  },
];
